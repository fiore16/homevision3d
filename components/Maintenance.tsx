export default function Maintenance() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-deeper">

      {/* Background image with overlay */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/images/Grand-Exterior.jpg')" }}
      />
      <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/60 to-black/80" />

      {/* Subtle animated glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gold/5 blur-3xl animate-pulse-slow pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-2xl mx-auto animate-fade-up">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <span className="text-xs font-sans font-semibold tracking-[0.35em] uppercase text-gold/80">
            HomeVision3D
          </span>
          <div className="w-px h-8 bg-gold/60" />
        </div>
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <span className="text-gold/50 text-xs tracking-widest uppercase">Stay Connected</span>
          <div className="h-px w-16 bg-gold/30" />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <a
            ...
            className="group flex items-center gap-3 px-7 py-3.5 border border-gold/40 hover:border-gold hover:bg-gold/10 transition-all duration-300 rounded-sm"
          >
